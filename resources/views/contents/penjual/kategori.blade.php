        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="card card-rounded">
                    ...
                    <div class="card-body">
                        @if(!empty($request->get('id')))
                            <form method="post" action="{{ route('penjual.update_kategori') }}">
                        @else 
                            <form method="post" action="{{ route('penjual.create_kategori') }}">  
                        @endif
                            @csrf
                            ...
                            @if(!empty($request->get('id')))
                                <a href="{{ route('penjual.kategori') }}" class="btn btn-danger mt-3">Kembali</a>
                            @endif
                        </form>
                    </div>
                </div>
                                ...
                                <tbody>
                                    ...
                                    @forelse($kategori as $r)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{url("penjual/kategori?id=$r->id")}}" 
                                                    class="btn btn-success btn-sm" title="Edit">
                                                    <i class="fa fa-edit"></i>  
                                                </a>   
                                                <a href="{{url("penjual/kategori/delete/$r->id")}}" 
